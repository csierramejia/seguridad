...
public class SQLConstant {
	...
	public static final String GET_USER_AUTH_MOBILE =
		...
		+ "FROM PERSONAS P "
		+ "JOIN USUARIOS U ON(U.ID_USUARIO=P.ID_PERSONA)"
		+ "JOIN USUARIOS_ROLES_EMPRESAS UR ON(UR.ID_USUARIO=U.ID_USUARIO) JOIN ROLES RO ON(RO.ID_ROL=UR.ID_ROL) "
	...
	public static final String GET_PROGRAMACION_VENDEDOR = "SELECT  HVD.OFICINA, HVD.PUNTO_VENTA " 
